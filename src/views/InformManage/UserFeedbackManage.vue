  ...
  <div id="userFeedInfoDiv">
      ...
      <el-col :sm="{span: 24}" :xs="{span: 24}">
        ...
        <el-table :data="feedbackData" border style="width: 100%">
          ...
          <el-table-column label="反馈附件" width="100">
            <el-link slot-scope="scope" type="primary" @click="lookAccess(scope.$index , scope.row)">查看附件</el-link>
          </el-table-column>
      ...
      <el-row :gutter="24">
        <el-col :sm="{span: 4}" :xs="{span: 24}">
          <el-button
            ...
            @click="lookAccess(currentFunctionIndex , currentFunctionObj)"
          >查看附件
          </el-button>
        </el-col>
        <el-col :sm="{span: 4}" :xs="{span: 24}">
        ...
        <el-col :sm="{span: 4}" :xs="{span: 24}">
          <el-button
            type="primary"
            style="width: 100% !important; margin-top: 10px;"
            @click="delFeedback(currentFunctionIndex , currentFunctionObj , true)"
          >删除反馈
          </el-button>
        </el-col>
        <el-col :sm="{span: 4}" :xs="{span: 24}">
          <el-button
            style="width: 100% !important; margin-top: 10px;"
            @click="userFeedbackDiaLogFlas.issueDescribeFlag = false"
          >关闭窗口
          </el-button>
        </el-col>
      </el-row>
    ...
    >
      ...
      <el-row :gutter="24">
        <el-col :sm="{span: 4}" :xs="{span: 24}">
          <el-button
            style="width: 100% !important; margin-top: 10px;"
            @click="userFeedbackDiaLogFlas.lookAccessFlag = false"
          >关闭窗口
          </el-button>
        </el-col>
      </el-row>
    ...
    >
      ...
      <el-row :gutter="24">
        <el-col :sm="{span: 24}" :xs="{span: 24}">
          <quill-editor
            v-if="currentFunctionObj.userFeedbackState == 1"
            ref="text"
          ...
          <quill-editor
            v-else
            ref="text"
            v-model="feedbackReplyInfo.replyContent"
            style="height: 100px;"
            class="myQuillEditor"
            disabled="true"
            :options="editorOption"
      ...
      <el-row :gutter="24" style="margin-top: 55px;">
        <el-col :sm="{span: 8}" :xs="{span: 24}">
          <el-button
            style="width: 100% !important; margin-top: 10px;"
            :disabled="currentFunctionObj.userFeedbackState == 2"
            type="primary"
            @click="yesReplyFeedback"
          >回复
          </el-button>
        </el-col>
        <el-col :sm="{span: 8}" :xs="{span: 24}">
          <el-button
            style="width: 100% !important; margin-top: 10px;"
            @click="userFeedbackDiaLogFlas.replyUserMessageFlag = false"
          >关闭窗口
          </el-button>
        </el-col>
      </el-row>
