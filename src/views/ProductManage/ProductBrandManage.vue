...
<template>
  <div id="productBrandDiv" v-loading="ProductBrandLoadings.productBrandCommonLoading">
      ...
      <el-row :gutter="24">
        ...
        <el-col :sm="{span: 8}" :xs="{span: 23}">
          <el-form-item>
            ...
            <el-button type="primary" style="width: 215px; margin-left: 70px;"
                       @click="productBrandDiaLogFlags.addProductBrandFlag = true">
              <svg-icon icon-class="tianjia" class-name=""
        ...
        <el-col :sm="{span: 8}" :xs="{span: 23}">
          <el-form-item>
            <el-button type="primary" icon="el-icon-search" @click="searchBrand"
                       style="width: 215px; margin-left: 70px;">搜索
            </el-button>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    >
      ...
      <el-form ref="addProductBrandForm" label-position="left" :inline="true" :model="addProductBrandForm"
               label-width="80px">
        <el-row :gutter="24">
          <el-col :sm="{span: 24}" :xs="{span: 24}">
        ...
        <el-row :gutter="24">
          ...
          <el-col :sm="{span: 8}" :xs="{span: 23}">
            <el-button style="width:100%;margin-bottom: 15px !important;"
                       @click="productBrandDiaLogFlags.addProductBrandFlag = false">关闭窗口
            </el-button>
          </el-col>
        </el-row>
      </el-form>
